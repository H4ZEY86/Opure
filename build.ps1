...
switch ($Target) {
    ...
    'local-recovery-point-policy' {
        & (Join-Path $PSScriptRoot 'eng\verify-local-recovery-point.ps1')
    }

    'founder-gate-a-readiness-policy' {
        & (Join-Path $PSScriptRoot 'eng\verify-founder-gate-a-readiness.ps1')
    }

    'founder-gate-a-launch' {
        & (Join-Path $PSScriptRoot 'eng\run-founder-gate-a.ps1') `
            -Configuration $Configuration
    }

    'founder-gate-a-crash-recovery' {
        & (Join-Path $PSScriptRoot 'eng\verify-founder-gate-a-crash-recovery.ps1') `
            -Configuration $Configuration
    }

    'founder-gate-a-ipc-security' {
        & (Join-Path $PSScriptRoot 'eng\verify-founder-gate-a-ipc-security.ps1') `
            -Configuration $Configuration
    }

    'founder-gate-a-filesystem' {
        & (Join-Path $PSScriptRoot 'eng\verify-founder-gate-a-filesystem.ps1') `
            -Configuration $Configuration
    }

    'founder-gate-a-configuration' {
        & (Join-Path $PSScriptRoot 'eng\verify-founder-gate-a-configuration.ps1') `
            -Configuration $Configuration
    }

    'founder-gate-a-trust-reconciliation' {
        & (Join-Path $PSScriptRoot 'eng\verify-founder-gate-a-trust-reconciliation.ps1') `
            -Configuration $Configuration
    }
    ...
    'gate-a-adr-evidence-matrix' {
        & (Join-Path $PSScriptRoot 'eng\verify-adr-evidence-matrix.ps1')
    }

    'founder-gate-a-review' {
        & (Join-Path $PSScriptRoot 'eng\verify-founder-gate-a-review.ps1')
    }

    'controlled-mutation-backlog' {
        & (Join-Path $PSScriptRoot 'eng\verify-controlled-mutation-backlog.ps1')
    }

    'patch-contract-policy' {
        & (Join-Path $PSScriptRoot 'eng\verify-patch-contract.ps1')
    }
}
